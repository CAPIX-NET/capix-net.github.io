...
description: CAPIX Treasury Manager (CTM) — a Microsoft-based multi-user treasury system compatible with Dynamics 365, SAP and other ERPs, with IAS 39 compliance and advanced cash management.
permalink: /ctm/
---
...
### ERP Integration
CTM is built on Microsoft technology and designed to work alongside your existing ERP platform. Whether you run **Microsoft Dynamics 365**, **SAP**, **FinanceOne** or another enterprise system, treasury data can flow between CTM and your ERP, enabling unified cash visibility across your organisation.
