...
CTC is our enterprise-scale software solution for larger treasury operations with many users -> [Learn More](/ctc/)

### CAPIX Investment Manager
CIM is our popular Microsoft-based software solution for investment and funds managers, with ERP integration support -> [Learn More](/cim/)

### Treasury in the Cloud
Through our partnership with Microsoft Azure, CAPIX now offers a cloud-based corporate treasury solution on the same cloud platform as Dynamics 365 -> [Learn More](/cct/)

### AI for Treasury
CAPIX has developed specialist expertise in AI for cashflow forecasting, risk management and autonomous treasury operations -> [Learn More](/ai/)

### ERP Integration
Learn how CAPIX treasury software integrates with Microsoft Dynamics 365 and other enterprise platforms -> [Learn More](/dynamics-365/)
